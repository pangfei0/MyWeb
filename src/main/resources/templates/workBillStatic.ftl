...
<@layout.archiveTemplate initScript="js/workBillStatic" header=headerContent  title=''>
<div class="panel panel-default">
    <div class="panel-heading">台量统计</div>
    <div class="panel-body">
        <form class="search-container search-form">
            ...
            <div class="tool-container pull-right">
                <button type="button" class="btn btn-export" v-on:click="exportWorkBillStatic"><span></span>导出</button>
            </div>
