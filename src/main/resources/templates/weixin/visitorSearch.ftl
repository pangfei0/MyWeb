...
<@layout.weixinMasterTemplate initScript='js/weixin/visitorSearch' header=headerContent title='电梯搜索'>
<div class="weui_search_bar" id="search_bar">
    <form class="weui_search_outer">
        <div class="weui_search_inner">
            <i class="weui_icon_search"></i>
            <input type="search" class="weui_search_input" id="search_input" placeholder="请输入电梯编号" required="">
...
<div class="weui_panel_bd">
    <a href="javascript:void(0);" class="weui_media_box weui_media_appmsg">
        ...
        <div class="weui_media_bd">
            <h4 class="weui_media_title">G1006H7</h4>
    ...
    <a href="javascript:void(0);" class="weui_media_box weui_media_appmsg">
        ...
        <div class="weui_media_bd">
            <h4 class="weui_media_title">GH100572</h4>
            <p class="weui_media_desc">由各种物质组成的巨型球状天体，叫做星球。星球有一定的形状，有自己的运行轨道。</p>
        </div>
    </a>
</div>
