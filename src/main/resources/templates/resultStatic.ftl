...
<@layout.archiveTemplate initScript="js/resultStatic" header=headerContent  title=''>
    ...
    <div class="panel-body">
        <form class="search-container search-form">
            ...
            <div class="tool-container pull-right">
                <button type="button" class="btn btn-export" v-on:click="resultExport"><span></span>导出</button>
            </div>
