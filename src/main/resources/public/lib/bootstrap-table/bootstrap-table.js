...
define(["jquery","translator"], function ($,translator) {
    ...
    BootstrapTable.LOCALES['en-US']  = {
        formatLoadingMessage: function () {
           return translator.translate("loadingData");
        },
        formatRecordsPerPage: function (pageNumber) {
            return translator.translate("everyPageShow")+pageNumber+translator.translate("records");
        },
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
           // return sprintf('Showing %s to %s of %s rows', pageFrom, pageTo, totalRows);
            return translator.translate("showRecordsFrom")+pageFrom+translator.translate("showRecordsTo")+pageTo+translator.translate("showRecordsToRecords")+","+translator.translate("totalPageBeforeText")+totalRows+translator.translate("totalRecordsAfterText");
        },
        formatSearch: function () {
           return translator.translate("search");
        },
        formatNoMatches: function () {
            return translator.translate("noRecord");
        },
        formatPaginationSwitch: function () {
           //return 'Hide/Show pagination';
            return translator.translate("hideShowPagination");
        },
        formatRefresh: function () {
            return translator.translate("refresh");
        },
        formatToggle: function () {
            return translator.translate("toggle");
        },
