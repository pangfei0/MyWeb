...
/**
            *  PagedListPack bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class PagedListPack
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for ReturnPage
                        */

                        
                                    protected int localReturnPage ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localReturnPageTracker = false ;

                           public boolean isReturnPageSpecified(){
                               return localReturnPageTracker;
                           }
                           ...
                           */
                           public  int getReturnPage(){
                            ...
                            /**
                               ...
                               */
                               public void setReturnPage(int param){
                            
                                       // setting primitive attribute tracker to true
                                       localReturnPageTracker =
                                       param != Integer.MIN_VALUE;
                                   
                                            this.localReturnPage=param;
                ...
                if (localListTracker){
                                    ...
                                    writeStartElement(null, namespace, "list", xmlWriter);
                                          ...
                                          if (localList==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localList);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    writeStartElement(null, namespace, "recordCount", xmlWriter);
                                               ...
                                               if (localRecordCount== Integer.MIN_VALUE) {
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localReturnPageTracker){
                                    namespace = "http://wsobjs.jmw.hesu.com/xsd";
                                    writeStartElement(null, namespace, "returnPage", xmlWriter);
                             
                                               if (localReturnPage== Integer.MIN_VALUE) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("returnPage cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localReturnPage));
                                               }
    ...
    public static class Factory{
        ...
        */
        public static PagedListPack parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            PagedListPack object =
                new PagedListPack();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"PagedListPack".equals(type)){
                                //find namespace for the prefix
                                String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (PagedListPack) ExtensionMapper.getTypeObject(
                                        nsUri, type, reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://wsobjs.jmw.hesu.com/xsd","list").equals(reader.getName()) || new javax.xml.namespace.QName("","list").equals(reader.getName()) ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://wsobjs.jmw.hesu.com/xsd","recordCount").equals(reader.getName()) || new javax.xml.namespace.QName("","recordCount").equals(reader.getName()) ){
                                    ...
                                    String content = reader.getElementText();
                                        ...
                                        reader.next();
                                               ...
                                               object.setRecordCount(Integer.MIN_VALUE);
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://wsobjs.jmw.hesu.com/xsd","returnPage").equals(reader.getName()) || new javax.xml.namespace.QName("","returnPage").equals(reader.getName()) ){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"returnPage" +"  cannot be null");
                                    }
                                    

                                    String content = reader.getElementText();
                                    
                                              object.setReturnPage(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
                                        ...
                                        reader.next();
                                               ...
                                               object.setReturnPage(Integer.MIN_VALUE);
