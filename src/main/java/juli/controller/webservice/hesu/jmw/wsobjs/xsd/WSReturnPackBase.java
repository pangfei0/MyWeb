...
/**
            *  WSReturnPackBase bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class WSReturnPackBase
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = WSReturnPackBase
                ...
                */
                        ...
                        /**
                        * field for WebSvcError
                        */

                        
                                    protected WebSvcError localWebSvcError ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localWebSvcErrorTracker = false ;

                           public boolean isWebSvcErrorSpecified(){
                               return localWebSvcErrorTracker;
                           }
                           ...
                           * @return com.hesu.jmw.wsobjs.xsd.WebSvcError
                           */
                           public  WebSvcError getWebSvcError(){
                               return localWebSvcError;
                           }
                            ...
                            /**
                               ...
                               * @param param WebSvcError
                               */
                               public void setWebSvcError(WebSvcError param){
                            localWebSvcErrorTracker = true;
                                   
                                            this.localWebSvcError=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":WSReturnPackBase",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "WSReturnPackBase",
    ...
    public static class Factory{
        ...
        */
        public static WSReturnPackBase parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            WSReturnPackBase object =
                new WSReturnPackBase();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"WSReturnPackBase".equals(type)){
                                //find namespace for the prefix
                                String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (WSReturnPackBase) ExtensionMapper.getTypeObject(
                                        nsUri, type, reader);
                              }
