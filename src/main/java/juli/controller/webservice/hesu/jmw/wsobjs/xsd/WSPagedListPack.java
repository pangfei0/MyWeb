...
/**
            *  WSPagedListPack bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class WSPagedListPack extends WSReturnPackBase
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = WSPagedListPack
                ...
                */
                        ...
                        /**
                        * field for PagedListPack
                        */

                        
                                    protected PagedListPack localPagedListPack ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localPagedListPackTracker = false ;

                           public boolean isPagedListPackSpecified(){
                               return localPagedListPackTracker;
                           }
                           ...
                           * @return com.hesu.jmw.wsobjs.xsd.PagedListPack
                           */
                           public  PagedListPack getPagedListPack(){
                               return localPagedListPack;
                           }
                            ...
                            /**
                               ...
                               * @param param PagedListPack
                               */
                               public void setPagedListPack(PagedListPack param){
                            localPagedListPackTracker = true;
                                   
                                            this.localPagedListPack=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":WSPagedListPack",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "WSPagedListPack",
                ...
                if (localWebSvcErrorTracker){
                                ...
                                } if (localPagedListPackTracker){
                                    if (localPagedListPack==null){

                                        writeStartElement(null, "http://wsobjs.jmw.hesu.com/xsd", "pagedListPack", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localPagedListPack.serialize(new javax.xml.namespace.QName("http://wsobjs.jmw.hesu.com/xsd","pagedListPack"),
                                        xmlWriter);
                                    }
                                }
                    xmlWriter.writeEndElement();
    ...
    public static class Factory{
        ...
        */
        public static WSPagedListPack parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            WSPagedListPack object =
                new WSPagedListPack();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"WSPagedListPack".equals(type)){
                                //find namespace for the prefix
                                String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (WSPagedListPack) ExtensionMapper.getTypeObject(
                                        nsUri, type, reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://wsobjs.jmw.hesu.com/xsd","pagedListPack").equals(reader.getName()) || new javax.xml.namespace.QName("","pagedListPack").equals(reader.getName()) ){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setPagedListPack(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setPagedListPack(PagedListPack.Factory.parse(reader));
