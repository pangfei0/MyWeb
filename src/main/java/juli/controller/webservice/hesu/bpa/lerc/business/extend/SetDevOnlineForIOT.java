...
/**
            *  SetDevOnlineForIOT bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SetDevOnlineForIOT
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns4");
                        ...
                        */
                                    ...
                                    protected String localDevStatus ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           public boolean isDevStatusSpecified(){
                               return localDevStatusTracker;
                           }
                           ...
                           */
                           public  String getDevStatus(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param DevStatus
                               */
                               public void setDevStatus(String param){
                            localDevStatusTracker = true;
                                   
                                            this.localDevStatus=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":setDevOnlineForIOT",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "setDevOnlineForIOT",
                ...
                if (localTokenTracker){
                             ...
                             } if (localDevStatusTracker){
                                    namespace = "http://extend.business.lerc.bpa.hesu.com";
                                    writeStartElement(null, namespace, "devStatus", xmlWriter);
                             

                                          if (localDevStatus==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localDevStatus);
    ...
    public static class Factory{
        ...
        */
        public static SetDevOnlineForIOT parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            SetDevOnlineForIOT object =
                new SetDevOnlineForIOT();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"setDevOnlineForIOT".equals(type)){
                                //find namespace for the prefix
                                String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SetDevOnlineForIOT) ExtensionMapper.getTypeObject(
                                        nsUri, type, reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://extend.business.lerc.bpa.hesu.com","devStatus").equals(reader.getName()) || new javax.xml.namespace.QName("","devStatus").equals(reader.getName()) ){
