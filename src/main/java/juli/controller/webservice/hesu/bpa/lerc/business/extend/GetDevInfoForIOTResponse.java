...
/**
            *  GetDevInfoForIOTResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetDevInfoForIOTResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://extend.business.lerc.bpa.hesu.com",
                "getDevInfoForIOTResponse",
                "ns4");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getDevInfoForIOTResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getDevInfoForIOTResponse",
    ...
    public static class Factory{
        ...
        */
        public static GetDevInfoForIOTResponse parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            GetDevInfoForIOTResponse object =
                new GetDevInfoForIOTResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getDevInfoForIOTResponse".equals(type)){
                                //find namespace for the prefix
                                String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetDevInfoForIOTResponse) ExtensionMapper.getTypeObject(
                                        nsUri, type, reader);
                              }
