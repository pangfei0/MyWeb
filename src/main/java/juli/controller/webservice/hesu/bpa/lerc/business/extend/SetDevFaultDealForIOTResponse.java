...
/**
 * SetDevFaultDealForIOTResponse.java
 *
...
/**
            *  SetDevFaultDealForIOTResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SetDevFaultDealForIOTResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://extend.business.lerc.bpa.hesu.com",
                "setDevFaultDealForIOTResponse",
                "ns4");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":setDevFaultDealForIOTResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "setDevFaultDealForIOTResponse",
    ...
    public static class Factory{
        ...
        */
        public static SetDevFaultDealForIOTResponse parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            SetDevFaultDealForIOTResponse object =
                new SetDevFaultDealForIOTResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"setDevFaultDealForIOTResponse".equals(type)){
                                //find namespace for the prefix
                                String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SetDevFaultDealForIOTResponse) ExtensionMapper.getTypeObject(
                                        nsUri, type, reader);
                              }
