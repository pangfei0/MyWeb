...
/**
 * GetDevListByCreateDateForIOT.java
 *
...
/**
            *  GetDevListByCreateDateForIOT bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetDevListByCreateDateForIOT
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://extend.business.lerc.bpa.hesu.com",
                "getDevListByCreateDateForIOT",
                "ns4");
                        ...
                        */
                                    ...
                                    protected String localBeginDate ;
                           ...
                           */
                           public  String getBeginDate(){
                            ...
                            /**
                               ...
                               */
                               public void setBeginDate(String param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getDevListByCreateDateForIOT",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getDevListByCreateDateForIOT",
    ...
    public static class Factory{
        ...
        */
        public static GetDevListByCreateDateForIOT parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            GetDevListByCreateDateForIOT object =
                new GetDevListByCreateDateForIOT();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getDevListByCreateDateForIOT".equals(type)){
                                //find namespace for the prefix
                                String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetDevListByCreateDateForIOT) ExtensionMapper.getTypeObject(
                                        nsUri, type, reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://extend.business.lerc.bpa.hesu.com","beginDate").equals(reader.getName()) || new javax.xml.namespace.QName("","beginDate").equals(reader.getName()) ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://extend.business.lerc.bpa.hesu.com","endDate").equals(reader.getName()) || new javax.xml.namespace.QName("","endDate").equals(reader.getName()) ){
