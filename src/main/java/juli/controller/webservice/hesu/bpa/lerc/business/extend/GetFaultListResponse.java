...
import juli.controller.webservice.hesu.jmw.wsobjs.xsd.WSPagedListPack;

/**
            *  GetFaultListResponse bean class
            */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns4");
                        ...
                        */
                                    ...
                                    protected WSPagedListPack local_return ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return com.hesu.jmw.wsobjs.xsd.WSPagedListPack
                           */
                           public  WSPagedListPack get_return(){
                               return local_return;
                           }
                            ...
                            /**
                               ...
                               * @param param _return
                               */
                               public void set_return(WSPagedListPack param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getFaultListResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getFaultListResponse",
    ...
    public static class Factory{
        ...
        */
        public static GetFaultListResponse parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            GetFaultListResponse object =
                new GetFaultListResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getFaultListResponse".equals(type)){
                                //find namespace for the prefix
                                String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetFaultListResponse) ExtensionMapper.getTypeObject(
                                        nsUri, type, reader);
                              }
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.set_return(WSPagedListPack.Factory.parse(reader));
