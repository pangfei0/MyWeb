...
/**
            *  SetDevFaultForIOT bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SetDevFaultForIOT
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns4");
                        ...
                        */
                        ...
                        /**
                        * field for DevFaultInfo
                        */

                        
                                    protected String localDevFaultInfo ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localDevFaultInfoTracker = false ;

                           public boolean isDevFaultInfoSpecified(){
                               return localDevFaultInfoTracker;
                           }
                           ...
                           * @return java.lang.String
                           */
                           public  String getDevFaultInfo(){
                               return localDevFaultInfo;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param DevFaultInfo
                               */
                               public void setDevFaultInfo(String param){
                            localDevFaultInfoTracker = true;
                                   
                                            this.localDevFaultInfo=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":setDevFaultForIOT",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "setDevFaultForIOT",
                ...
                if (localTokenTracker){
                             ...
                             } if (localDevFaultInfoTracker){
                                    namespace = "http://extend.business.lerc.bpa.hesu.com";
                                    writeStartElement(null, namespace, "devFaultInfo", xmlWriter);
                             

                                          if (localDevFaultInfo==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localDevFaultInfo);
    ...
    public static class Factory{
        ...
        */
        public static SetDevFaultForIOT parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            SetDevFaultForIOT object =
                new SetDevFaultForIOT();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"setDevFaultForIOT".equals(type)){
                                //find namespace for the prefix
                                String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SetDevFaultForIOT) ExtensionMapper.getTypeObject(
                                        nsUri, type, reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://extend.business.lerc.bpa.hesu.com","devFaultInfo").equals(reader.getName()) || new javax.xml.namespace.QName("","devFaultInfo").equals(reader.getName()) ){
