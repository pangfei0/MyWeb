...
/**
            *  SetDevFaultDealForIOT bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SetDevFaultDealForIOT
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://extend.business.lerc.bpa.hesu.com",
                "setDevFaultDealForIOT",
                "ns4");
                        ...
                        */
                        ...
                        /**
                        * field for DevFaultDealInfo
                        */

                        
                                    protected String localDevFaultDealInfo ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localDevFaultDealInfoTracker = false ;

                           public boolean isDevFaultDealInfoSpecified(){
                               return localDevFaultDealInfoTracker;
                           }
                           ...
                           * @return java.lang.String
                           */
                           public  String getDevFaultDealInfo(){
                               return localDevFaultDealInfo;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param DevFaultDealInfo
                               */
                               public void setDevFaultDealInfo(String param){
                            localDevFaultDealInfoTracker = true;
                                   
                                            this.localDevFaultDealInfo=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":setDevFaultDealForIOT",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "setDevFaultDealForIOT",
                ...
                if (localTokenTracker){
                             ...
                             } if (localDevFaultDealInfoTracker){
                                    namespace = "http://extend.business.lerc.bpa.hesu.com";
                                    writeStartElement(null, namespace, "devFaultDealInfo", xmlWriter);
                             

                                          if (localDevFaultDealInfo==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localDevFaultDealInfo);
    ...
    public static class Factory{
        ...
        */
        public static SetDevFaultDealForIOT parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            SetDevFaultDealForIOT object =
                new SetDevFaultDealForIOT();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"setDevFaultDealForIOT".equals(type)){
                                //find namespace for the prefix
                                String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SetDevFaultDealForIOT) ExtensionMapper.getTypeObject(
                                        nsUri, type, reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://extend.business.lerc.bpa.hesu.com","devFaultDealInfo").equals(reader.getName()) || new javax.xml.namespace.QName("","devFaultDealInfo").equals(reader.getName()) ){
