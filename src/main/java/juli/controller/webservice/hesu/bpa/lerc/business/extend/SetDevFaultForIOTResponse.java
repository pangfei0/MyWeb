...
/**
 * SetDevFaultForIOTResponse.java
 *
...
/**
            *  SetDevFaultForIOTResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SetDevFaultForIOTResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://extend.business.lerc.bpa.hesu.com",
                "setDevFaultForIOTResponse",
                "ns4");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":setDevFaultForIOTResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "setDevFaultForIOTResponse",
    ...
    public static class Factory{
        ...
        */
        public static SetDevFaultForIOTResponse parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            SetDevFaultForIOTResponse object =
                new SetDevFaultForIOTResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"setDevFaultForIOTResponse".equals(type)){
                                //find namespace for the prefix
                                String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SetDevFaultForIOTResponse) ExtensionMapper.getTypeObject(
                                        nsUri, type, reader);
                              }
