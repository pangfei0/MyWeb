...
/**
 * GetDevListByCreateDateForIOTResponse.java
 *
...
/**
            *  GetDevListByCreateDateForIOTResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetDevListByCreateDateForIOTResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://extend.business.lerc.bpa.hesu.com",
                "getDevListByCreateDateForIOTResponse",
                "ns4");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getDevListByCreateDateForIOTResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getDevListByCreateDateForIOTResponse",
    ...
    public static class Factory{
        ...
        */
        public static GetDevListByCreateDateForIOTResponse parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            GetDevListByCreateDateForIOTResponse object =
                new GetDevListByCreateDateForIOTResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getDevListByCreateDateForIOTResponse".equals(type)){
                                //find namespace for the prefix
                                String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetDevListByCreateDateForIOTResponse) ExtensionMapper.getTypeObject(
                                        nsUri, type, reader);
                              }
