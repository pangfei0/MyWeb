...
public class ExcelUtil {
    ...
    public static void export2Browser(HttpServletResponse response, ExcelExportData setInfo, String outputExcelFileName) throws Exception {
        OutputStream output = response.getOutputStream();
        response.reset();
        response.setHeader("Content-disposition", "attachment; filename=" + URLEncoder.encode(outputExcelFileName, "UTF-8") + ".xls");
        response.setContentType("application/msexcel");
        output.write(export2ByteArray(setInfo));
        output.close();
    }
    ...
    private static void initDateCellStyle() {
        ...
        dateStyle.setFillBackgroundColor((short)23);
    }
    ...
    private static void initHeadCellStyle() {
        ...
        headStyle.setTopBorderColor((short)4);
        headStyle.setBottomBorderColor((short)4);
        headStyle.setLeftBorderColor((short)4);
        headStyle.setRightBorderColor((short)4);
    }
    ...
    private static void initContentCellStyle() {
        ...
        contentStyle.setTopBorderColor((short)4);
        contentStyle.setBottomBorderColor((short)4);
        contentStyle.setLeftBorderColor((short)4);
        contentStyle.setRightBorderColor((short)4);
